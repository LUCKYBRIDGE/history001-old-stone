...
현재 프로젝트는 **ChatGPT 채팅 중심 개발 워크플로우로 전환하는 초기 운영체계 구축 단계**다.

## Completed planning documents

현재 대화 기준으로 다음 상위 기획 문서가 존재한다.
...
1. 현재 확정된 01~03 문서를 저장소의 canonical 문서로 정리
2. 기존 04 사냥 실제 플레이 흐름을 v2로 리비전
3. `05_ROLE_EXPERIENCE_MAP.md` 작성
4. ChatGPT 개발용 기술 설계 확정
5. 실제 웹앱 골격 구축
6. 사냥 Vertical Slice 개발·검증
7. 채집 설계·개발
8. 머무는 역할 설계·개발
9. 같은 하루 + 며칠 변화 통합
10. 이동·새 거처 구현
11. 시각 맥락·아트 방향 확정 후 최종 이미지 제작·적용
12. 학생 테스트 후 v1.0
