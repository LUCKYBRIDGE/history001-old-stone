...
# **Design Reboot R2 — Stage 01~06 재설계 완료. 다음 공식 단계는 R2 Stage 07 — Embodied Experience Skeleton.**
...
8. 몸을 낮추는 POV
9. 사람의 시선/위치 반응
10. 짧은 Perspective Bridge prototype
...
- 기존 Hunt v0.1 화면에 텍스트만 추가하고 `몰입 개선 완료` 처리
- 최종 이미지 대량 제작
- 자유 3D/FPS 전환
- NPC AI 시스템 구축
- Gather/Camp를 기존 Hunt UI 복사로 구현

새 구현은 반드시 R2 Stage 01~06을 기준으로 한다.
